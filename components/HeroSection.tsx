        ...
        <div className='max-w-5xl mx-auto text-center'>
          ...
          <SlideIn direction='up' delay={0.4} duration={1.0}>
            <h1 className='text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-8 tracking-tight'>
              <AnimatedText animation='slide' direction='up' delay={0.6}>
                <span className='block mb-2'>Transform Your</span>
              </AnimatedText>
              <AnimatedText animation='slide' direction='up' delay={0.8}>
              ...
              <AnimatedText animation='slide' direction='up' delay={1.0}>
