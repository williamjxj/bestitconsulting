  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        name: 'Strategic Planning',
        included: true,
        description: '6-month roadmap',
      },
      {
        name: 'Weekly Check-ins',
        included: true,
        description: '4 hours per week',
      },
      {
        name: 'Priority Support',
        included: true,
        description: 'Response within 4h',
      },
      {
    ...
    features: [
      {
        name: 'Initial Assessment',
        included: true,
        description: 'Enterprise-wide audit',
      },
      {
        name: 'Strategic Planning',
        included: true,
        description: '12-month roadmap',
      },
      {
        name: 'Dedicated Team',
        included: true,
        description: 'Full-time consultants',
      },
      {
        name: '24/7 Support',
        included: true,
      ...
      <div className='container mx-auto px-4'>
        ...
        >
          ...
          <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
            Compare our service tiers and find the perfect solution for your
            business needs. All plans include our core consulting expertise with
