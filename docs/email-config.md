...
Email system for Best IT Consulting using Resend service.

## Quick Setup

1. **Create Resend account**: [resend.com](https://resend.com) (free: 3,000 emails/month)
...
3. **Configure environment**:
   ...
   ```
4. **Deploy to Vercel**: Add environment variables in project settings

## Features

- Contact form submissions → business email notifications
- Customer confirmation emails with branding
...
- **Emails not received**: Check spam/junk folder first
- **API errors**: Verify RESEND_API_KEY is correct
- **Delivery issues**: Emails use `onboarding@resend.dev` sender
...
**Check delivery status**: [resend.com/emails](https://resend.com/emails)
