/**
 * Technology data for the showcase
 *
 * Extracted from the main page and organized by categories
 * for use in the TechnologyShowcase component
 */

import {
  TechnologyCategoryData,
  TechnologyCategory,
} from '@/specs/002-tech-showcase-redesign/contracts/component-interfaces'

// Technology icons as React components
const ReactIcon = () => (
...
const KubernetesIcon = () => (
  <svg className='w-8 h-8' viewBox='0 0 24 24' fill='currentColor'>
    <path d='M10.204 14.35l.007.01-.999 2.413a5.171 5.171 0 0 1-2.075-2.597l2.578-.437.004.005a.44.44 0 0 1 .484.606zm-.833-2.129a.44.44 0 0 1 0-.611l.005.004 1.67-1.906a5.739 5.739 0 0 1 .049-.056 5.18 5.18 0 0 1 1.003 3.966l-2.578.437-.004-.005a.44.44 0 0 1-.145-.829zm.173-2.983l.002.005a.44.44 0 0 1 .284-.022l.005-.003 2.573.422a5.165 5.165 0 0 1-1.003-3.966 5.739 5.739 0 0 1-.05.056l-1.669 1.906-.005-.004a.44.44 0 0 1-.137.606zm1.084 2.132l1.678 1.915.003-.003a.44.44 0 0 1-.24.054l-.007.01-2.413-.001a5.171 5.171 0 0 1 2.597 2.075l.437-2.578-.005-.004a.44.44 0 0 1-.611 0l.004-.005a5.739 5.739 0 0 1 .056-.049 5.18 5.18 0 0 1-3.966-1.003l-.437 2.578.005.004a.44.44 0 0 1 .829.145l-.005.004a5.739 5.739 0 0 1-.056.049 5.18 5.18 0 0 1-3.966 1.003l.437-2.578-.005-.004a.44.44 0 0 1 .144.829l.004-.005a5.739 5.739 0 0 1 .049.056 5.18 5.18 0 0 1 1.003-3.966l-2.578-.437.004.005a.44.44 0 0 1-.829-.145l.004.005a5.739 5.739 0 0 1-.049-.056 5.18 5.18 0 0 1 3.966-1.003l-.437 2.578.005-.004a.44.44 0 0 1-.145-.829l-.004.005a5.739 5.739 0 0 1-.056-.049 5.18 5.18 0 0 1 3.966 1.003l.437-2.578-.005.004a.44.44 0 0 1 .829.145l-.005-.004a5.739 5.739 0 0 1 .056.049 5.18 5.18 0 0 1-1.003 3.966l2.578.437-.004-.005a.44.44 0 0 1 .145.829l.004-.005a5.739 5.739 0 0 1 .049.056 5.18 5.18 0 0 1-3.966 1.003l.437 2.578-.005-.004a.44.44 0 0 1-.829-.145l.005.004a5.739 5.739 0 0 1-.056-.049 5.18 5.18 0 0 1-1.003-3.966l-2.578-.437.004.005a.44.44 0 0 1-.145-.829l-.004.005a5.739 5.739 0 0 1-.049-.056 5.18 5.18 0 0 1 3.966-1.003l-.437-2.578.005.004a.44.44 0 0 1 .829.145z' />
  </svg>
)
...
// New icons for updated technologies
const ShadcnUIIcon = () => (
  <svg className='w-8 h-8' viewBox='0 0 24 24' fill='currentColor'>
...
export const technologyCategories: TechnologyCategoryData[] = [
  {
    id: TechnologyCategory.FRONTEND,
  ...
  {
    id: TechnologyCategory.CLOUD_DEVOPS,
    name: 'Cloud & DevOps',
    order: 3,
    technologies: [
      {
        ...
        category: TechnologyCategory.CLOUD_DEVOPS,
