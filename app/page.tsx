    ...
    <Layout>
      <div className='min-h-screen'>
        ...
        <section className='py-20 bg-gradient-to-br from-slate-50 to-blue-50'>
          <div className='container mx-auto px-4'>
            <div className='text-center mb-16'>
              <span className='inline-block px-4 py-1.5 text-sm font-medium bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-800 rounded-full mb-4 border border-blue-200/50'>
                Technology Stack
              </span>
                ...
                <div className='grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6 items-center justify-items-center'>
                  {[
                    ...
                    <div key={index} className='group cursor-pointer'>
                      <div className='relative w-24 h-24 bg-white rounded-2xl border border-gray-200/50 flex flex-col items-center justify-center hover:border-blue-300/50 transition-all duration-300 hover:scale-105 hover:shadow-lg'>
                        <div
                          className={`text-white bg-gradient-to-br ${tech.color} p-2 rounded-xl mb-2 group-hover:scale-110 transition-transform duration-300`}
                        >
                          {tech.icon}
                        </div>
                    ...
                    },
                    {
                      ...
                      icon: (
                        <svg
                          ...
                          fill='currentColor'
                        >
                          <path d='M10.204 14.35l.007.01-.999 2.413a5.171 5.171 0 0 1-2.075-2.597l2.578-.437.004.005a.44.44 0 0 1 .484.606zm-.833-2.129a.44.44 0 0 1 0-.611l.005.004 1.67-1.906a5.739 5.739 0 0 1 .049-.056 5.18 5.18 0 0 1 1.003 3.966l-2.578.437-.004-.005a.44.44 0 0 1-.145-.829zm.173-2.983l.002.005a.44.44 0 0 1 .284-.022l.005-.003 2.573.422a5.165 5.165 0 0 1-1.003-3.966 5.739 5.739 0 0 1-.05.056l-1.669 1.906-.005-.004a.44.44 0 0 1-.137.606zm1.084 2.132l1.678 1.915.003-.003a.44.44 0 0 1-.24.054l-.007.01-2.413-.001a5.171 5.171 0 0 1 2.597 2.075l.437-2.578-.005-.004a.44.44 0 0 1-.611 0l.004-.005a5.739 5.739 0 0 1 .056-.049 5.18 5.18 0 0 1-3.966-1.003l-.437 2.578.005.004a.44.44 0 0 1 .829.145l-.005.004a5.739 5.739 0 0 1-.056.049 5.18 5.18 0 0 1-3.966 1.003l.437-2.578-.005-.004a.44.44 0 0 1 .144.829l.005-.004a5.739 5.739 0 0 1 .049.056 5.18 5.18 0 0 1 1.003-3.966l-2.578-.437.004.005a.44.44 0 0 1-.829-.145l.004.005a5.739 5.739 0 0 1-.049-.056 5.18 5.18 0 0 1 3.966-1.003l-.437 2.578.005-.004a.44.44 0 0 1-.145-.829l-.004.005a5.739 5.739 0 0 1-.056-.049 5.18 5.18 0 0 1 3.966 1.003l.437-2.578-.005.004a.44.44 0 0 1 .829.145l-.005-.004a5.739 5.739 0 0 1 .056.049 5.18 5.18 0 0 1-1.003 3.966l2.578.437-.004-.005a.44.44 0 0 1 .145.829l.004-.005a5.739 5.739 0 0 1 .049.056 5.18 5.18 0 0 1-3.966 1.003l.437 2.578-.005-.004a.44.44 0 0 1-.829-.145l.005.004a5.739 5.739 0 0 1-.056-.049 5.18 5.18 0 0 1-1.003-3.966l-2.578-.437.004.005a.44.44 0 0 1-.145-.829l-.004.005a5.739 5.739 0 0 1-.049-.056 5.18 5.18 0 0 1 3.966-1.003l-.437-2.578.005.004a.44.44 0 0 1 .829.145z' />
                        </svg>
                      ),
                    },
                    {
