...
import {
  ArrowRight, Star, Quote, TrendingUp, Award, Users,
  CheckCircle2, Zap, Heart, ThumbsUp, Building2, X
} from 'lucide-react';
...
export default function TestimonialsPage() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      avatar: "👨‍💼",
      rating: 5,
      quote: "They delivered our MVP in 8 weeks. Others quoted 6 months. We secured Series A funding.",
          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-blue-100 mb-8">
                Join 50+ companies who've already transformed their businesses with us
              </p>
            ...
            <div className="p-8 md:p-12">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-blue-600 font-medium">{selectedTestimonial.company}</p>
                </div>
              </div>
              ...
              <div className="prose prose-lg max-w-none mb-8">
                <h3 className="text-2xl font-bold text-slate-900 mb-4">The Full Story</h3>
                <p className="text-slate-600 leading-relaxed">{selectedTestimonial.fullStory}</p>
              </div>
