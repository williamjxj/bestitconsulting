  ...
  const projects = [
    {
      ...
      challenge:
        'Manual patient data entry was taking nurses 3+ hours per shift, reducing time for actual patient care.',
      solution:
        'Built an AI assistant that extracts data from medical forms, integrates with EHR systems, and reduces data entry by 90%.',
      results: [
      ...
      testimonial: {
        quote:
          'This AI assistant gave our nurses their time back. Patient satisfaction scores increased 40%.',
    ...
    },
    {
      ...
      challenge:
        "10-year-old e-commerce platform couldn't handle Black Friday traffic. Site crashed every major sale.",
      solution:
        'Rebuilt from scratch using Next.js, implemented edge caching, and migrated to serverless architecture.',
      results: [
      ...
      testimonial: {
        quote:
          'First Black Friday without a crash in 5 years. Sales were up 200%.',
        author: 'Mike Chen',
        role: 'CTO',
      },
    },
    {
      ...
      challenge:
        'Traders needed real-time market data but legacy systems had 15+ second delays.',
      solution:
        'Built real-time data pipeline with WebSockets, React frontend, and microservices architecture.',
      results: [
      ...
      testimonial: {
        quote:
          'Game-changer for our trading desk. Decisions are now data-driven and instant.',
    ...
    },
    {
      ...
      challenge:
        'Legacy on-premise infrastructure costing $500K/year with frequent outages.',
      solution:
        'Migrated to AWS with Kubernetes, implemented CI/CD, and reduced infrastructure costs by 60%.',
      results: [
      ...
      testimonial: {
        quote:
          "ROI was visible in month one. Best technical investment we've made.",
        author: 'Lisa Park',
        role: 'VP Engineering',
      },
    },
    {
      ...
      solution:
        'React Native app with biometric auth, real-time transactions, and AI-powered insights.',
      results: [
      ...
      testimonial: {
        quote:
          'They delivered in 8 weeks what others quoted 6 months for. Incredible team.',
        author: 'Tom Anderson',
        role: 'Founder & CEO',
      },
    },
    {
      ...
      challenge:
        'Data scientists wasting hours setting up experiments. GPU utilization under 30%.',
      solution:
        'Built self-service ML platform with automated provisioning, monitoring, and cost optimization.',
      results: [
      ...
      testimonial: {
        quote:
          'Our data science team is now 5x more productive. This platform is phenomenal.',
      ...
      <section className='relative min-h-[70vh] flex items-center overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900'>
        ...
        <div className='container mx-auto px-6 relative z-10'>
          <div className='max-w-4xl'>
            ...
            >
              From Fortune 500 companies to fast-growing startups, here's how
              we've helped businesses transform with AI and modern technology.
            </motion.p>
          </div>
        </div>
      </section>
          ...
          <ScrollReveal>
            <div className='max-w-3xl mx-auto text-center'>
              ...
              <p className='text-xl text-blue-100 mb-8'>
                Let's discuss how we can transform your business with proven
                strategies
              </p>
              ...
              <div className='flex items-start justify-between mb-8'>
                <div className='flex items-start gap-6'>
                  ...
                  <div>
                    ...
                    <h2 className='text-4xl font-bold text-slate-900 mt-4 mb-2'>
