...
import {
  ArrowRight, Heart, Target, Users, Zap, TrendingUp, Award,
  Code, Globe, Sparkles, Coffee, Rocket, Star, CheckCircle2
} from 'lucide-react';
...
export default function AboutPage() {
  ...
  const values = [
    ...
    },
    {
      ...
      description: "Speed matters, but not at the expense of quality. We ship fast AND right.",
      color: "yellow"
    },
    {
      icon: Users,
      title: "Radical Transparency",
      description: "No surprises. Ever. We communicate early, often, and honestly.",
      color: "blue"
    },
    {
      icon: Rocket,
      title: "Continuous Innovation",
      description: "We stay ahead so you stay ahead. Constant learning is our superpower.",
      color: "purple"
    }
  ];
  ...
  const milestones = [
    ...
    { year: "2007", event: "Building e-commerce at Best Buy Canada", icon: Code },
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative min-h-[70vh] flex items-center overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl">
            ...
            >
              We're engineers who've shipped real products at FedEx, WebMD, Credit Suisse, and HSBC.
              Now we're helping companies like yours build faster with AI.
            </motion.p>
          </div>
        </div>
      </section>
            ...
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-2xl text-slate-700 leading-relaxed">
                  To democratize AI-powered development so every business can ship production code
                  at the speed of Silicon Valley startups—without the Silicon Valley price tag.
                </p>
              </div>
            </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              ...
              <p className="text-xl text-slate-600">
                These aren't just words on a wall. They're how we work every single day.
              </p>
            </div>
          </ScrollReveal>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            <StaggerChildren staggerDelay={0.15}>
              {values.map((value, idx) => (
                ...
                >
                  <div className={`p-4 bg-${value.color}-100 rounded-xl w-fit mb-6`}>
      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-6">
          <ScrollReveal>
            <div className="text-center max-w-3xl mx-auto mb-16">
              <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Meet the Team</h2>
              <p className="text-xl text-slate-600">
            ...
            <StaggerChildren staggerDelay={0.1}>
              {teamMembers.map((member, idx) => (
                ...
                >
                  ...
                  <p className="text-blue-600 text-sm mb-4 text-center font-medium">{member.role}</p>
                  ...
                  <div className="pt-4 border-t border-slate-200">
                    <p className="text-slate-500 text-sm italic">"{member.quote}"</p>
                  </div>
                </motion.div>
              ))}
            </StaggerChildren>
          ...
          <ScrollReveal>
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-blue-100 mb-8">
                We're always looking for interesting problems to solve and great teams to work with
              </p>
